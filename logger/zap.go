// got from: https://github.com/betterstack-community/go-logging/blob/zap/logger/logger.go
...
func Get() *zap.Logger {
	once.Do(func() {
		...
		// lumberjack: automatically rotate log files so they don't get too large
